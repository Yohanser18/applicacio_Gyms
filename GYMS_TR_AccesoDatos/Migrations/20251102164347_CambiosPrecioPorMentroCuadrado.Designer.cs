...
namespace GYMS_TR_AccesoDatos.Migrations
{
    ...
    [Migration("20251102164347_CambiosPrecioPorMentroCuadrado")]
    partial class CambiosPrecioPorMentroCuadrado
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GYMS_TR_Modelos.Orden", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("UsuarioapliacacioId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("UsuarioapliacacioId");

                    b.ToTable("Orden");
                });

            modelBuilder.Entity("GYMS_TR_Modelos.OrdenDetalle", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GYMS_TR_Modelos.Venta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("FinalVentaTotal")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("GYMS_TR_Modelos.VentaDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GYMS_TR_Modelos.Orden", b =>
                {
                    b.HasOne("GYMS_TR_Modelos.UsuarioAplicacion", "UsuarioAplicacion")
                        .WithMany()
                        .HasForeignKey("UsuarioapliacacioId")
            ...
            modelBuilder.Entity("GYMS_TR_Modelos.OrdenDetalle", b =>
                {
                    b.HasOne("GYMS_TR_Modelos.Orden", "Orden")
                        .WithMany()
                        .HasForeignKey("OrdenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GYMS_TR_Modelos.Producto", "Producto")
                        .WithMany()
            ...
            modelBuilder.Entity("GYMS_TR_Modelos.VentaDetalle", b =>
                {
                    ...
                    b.HasOne("GYMS_TR_Modelos.Venta", "Venta")
                        .WithMany()
